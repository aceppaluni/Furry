        ...
        <ScrollView showsHorizontalScrollIndicator={false} horizontal >
          <View style={{ flexDirection: "row", alignItems: "center", gap: 50 }}>
            <View>
              ...
              <Text style={{width: 200, marginTop: 15, fontSize: 18, lineHeight: 24, marginBottom: 4}}>
            ...
            {item?.profileImages?.slice(0, 1).map((item, index) => (
              <Image source={{uri: item}} style={{width: 280, height: 280, resizeMode:'cover', borderRadius: 5 }} />
            ))}
          </View>
        </ScrollView>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 20 }}>
              ...
              {liked ? (
                ...
                <Pressable onPress={() => handelLike(item?._id)}
                style={{
                  width: 50,
                  height: 50,
                  borderRadius: 25,
        ...
        <View style={{
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 20 }}>
            ...
            {selected ? (
                ...
                <Pressable onPress={() => handelOtherSide(item?._id)}
                style={{
                  width: 50,
                  height: 50,
                  borderRadius: 25,
